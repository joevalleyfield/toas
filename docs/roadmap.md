...
- `659` roots-on-top event graph visualization active: renderer foundation is being closed out with canonical snapshots, real-event adapters, and forest rendering.
