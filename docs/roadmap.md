...
- `574` stdout-proxy lane leakage and stream semantic contract restoration opened: complete lane ownership split so assistant projection text cannot traverse tool-progress paths, with assertion-backed contract enforcement and integration coverage.
