...
- `570` retire stateful branch-selection and make default `step` transcript-authoritative opened: branch/history selection is being reframed toward explicit transactional selection (not lingering hidden execution state)
