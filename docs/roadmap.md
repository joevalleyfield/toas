...
- `501`/`502`/`503` opened from post-498/499 rerank to target current highest-leverage hotspots across shell streaming, replay boundary flow, and daemon watch run-store flow.
