...
- added forced-cancel recovery cleanliness assertion in `tests/test_daemon_run_store.py`:
  - after forced timeout cancellation reaches terminal `cancelled`, a subsequent run is registered and watched successfully without stale-cancel carryover.
