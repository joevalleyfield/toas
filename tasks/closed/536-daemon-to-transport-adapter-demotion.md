...
## Boundary Contract
- Public runtime surface: `toas.runtime.async_activity_store_api`
- Backing implementation detail: `toas.daemon.run_store` (consumed through `runtime.async_activity_store`)
- Test split:
  - adapter/runtime contract assertions in `tests/test_runtime_async_activity_store_api.py`
  - backing implementation behavior assertions in `tests/test_daemon_run_store.py`
