...
- 2026-05-24: closure pass completed after local-host default cutover and architecture-shift cleanup; implementation-level annotation/follow-on work continues under `554`.
