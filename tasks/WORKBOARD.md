...
- **[T677]** Design and implement a synchronous, deterministic, and local task-capture tool `capture_task_thread` to let the active agent explicitly defer side thr...
<!-- WORKBOARD:NOW:END -->
...
- **[T669]** keywords: transport, implementation, closed, compatibility, async, subscribe, watch, parity
