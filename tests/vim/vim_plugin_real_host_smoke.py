...
class _FakeLlmHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        payload = {
            ...
            "model": "fake-model",
            "choices": [{"index": 0, "delta": {"content": "hello from fake llm\n"}, "finish_reason": None}],
        }
...
def run(vim_bin: str, timeout_s: float) -> dict[str, object]:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="toas-vim-real-host-") as td:
            tdp = Path(td)
            ...
            ok = (
                ...
                and "hello from fake llm" in result.get("text", "")
            )
